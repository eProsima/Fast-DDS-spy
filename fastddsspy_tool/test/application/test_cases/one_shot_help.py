    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            output=(
                ...
                '\tquit                                      : exit interactive CLI and close '
                'program.\n\n'
                '\tparticipants                              : DomainParticipants discovered in '
                'the network.\n\n'
                '\tparticipants verbose                      : verbose information about '
                'DomainParticipants discovered in the network.\n\n'
                '\tparticipants <Guid>                       : verbose information related with '
                'a specific DomainParticipant.\n\n'
                '\twriters                                   : DataWriters discovered in '
                'the network.\n\n'
                '\twriters verbose                           : verbose information about '
                'DataWriters '
                'discovered in the network.\n\n'
                '\twriters <Guid>                            : verbose information related with '
                'a specific DataWriter.\n\n'
                '\treader                                    : DataReaders discovered in '
                'the network.\n\n'
                '\treader verbose                            : verbose information about '
                'DataReaders discovered in the network.\n\n'
                '\treader <Guid>                             : verbose information related with '
                'a specific DataReader.\n\n'
                '\ttopics                                    : Topics discovered in the '
                'network in compact format.\n\n'
                '\ttopics v                                  : Topics discovered in '
                'the network.\n\n'
                '\ttopics vv                                 : verbose information about Topics '
                'discovered in the network.\n\n'
                '\ttopics <name>                             : Topics discovered in the network '
                'filtered by name (wildcard allowed (*)).\n\n'
                '\ttopics <name> idl                         : Display the IDL type definition '
                'for topics matching <name> (wildcards allowed).\n\n'
                ...
                '\tfilter set <category> <filter_str>        : Set <category> filter list with '
                '<filter_str> as first value.\n\n'
                '\tfilter add <category> <filter_str>        : Add <filter_str> in <category> '
                'filter list.\n\n'
                '\tfilter remove <category> <filter_str>     : Remove <filter_str> in <category>'
                ' filter list.\n\n'
                '\techo <name>                               : data of a specific Topic '
                '(Data Type must be discovered).\n\n'
                '\techo <wildcard_name>                      : data of Topics matching the '
                'wildcard name '
                ...
                '\techo all                                  : verbose data of all topics '
