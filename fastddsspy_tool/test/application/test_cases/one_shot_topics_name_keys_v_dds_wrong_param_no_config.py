...
class TestCase_instance (test_class.TestCase):
    ...
    def __init__(self):
        ...
        Launch this test with:
            fastddsspy topics HelloWorldTopic K WRONG
            AdvancedConfigurationExample publisher
        """
        super().__init__(
            name='TopicsNameKeysDDSCommand',
            one_shot=True,
            command=[],
            dds=True,
            config='',
            arguments_dds=[],
            arguments_spy=['topics', 'HelloWorldTopic', 'K', 'WRONG'],
            commands_spy=[],
            output='Last argument <WRONG> is not valid. \
