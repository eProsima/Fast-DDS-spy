...
configuration_discovery_time.yaml',
            ...
            output=(
                ...
                '\tfilters add partitions <filter_str>         : '
                'Add <filter_str> in partitions '
                'filter list.\n'
                '\tfilters remove partitions <filter_str>      : '
                'Remove <filter_str> in partitions '
                'filter list.\n'
                '\tfilters set topic <topic_name> <filter_str> : '
                'Set topic filter list with '
