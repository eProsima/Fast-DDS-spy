...
class TestCase_instance (test_class.TestCase):
    ...
    def __init__(self):
        ...
        This TestCase creates three filter list "partitions", "partition", "topics" and remove "partition" list.
        ...
        super().__init__(
            ...
            arguments_dds=[],
            arguments_spy=[],
            commands_spy=['filter set partitions A', 'filter set partition A', 'filter set topics Square', 'filter remove partition', 'filters'],
            output=(
                'Filter lists (2)\n'
                '\n\n\n'
                '  partitions (1):\n'
