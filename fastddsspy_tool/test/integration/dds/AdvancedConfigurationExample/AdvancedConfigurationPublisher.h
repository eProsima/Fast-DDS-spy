...
private:
    ...
    // std::array<eprosima::fastdds::dds::DataWriter*, NUM_TOPICS> writers_;
    std::vector<eprosima::fastdds::dds::DataWriter*> writers_ = std::vector<eprosima::fastdds::dds::DataWriter*>(NUM_TOPICS, nullptr);
