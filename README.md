...
> Please migrate to the [latest release](https://github.com/eProsima/Fast-DDS-spy/releases/latest), which is still compatible with applications running with *eProsima Fast DDS* v2.
